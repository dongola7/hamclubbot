...
def main():
    ...
    # Load extensions
    extensions = [
        "hamclubbot.extensions.conditions",
        "hamclubbot.extensions.clubinfo",
        "hamclubbot.extensions.about",
        "hamclubbot.extensions.pota",
    ]
    ...
    try:
        ...
        logger.critical("Gateway connection to discord closed: code=%s reason=%s",
            ex.code, ex.reason)
